      ...
      <div className="funge-footer container-fluid col-11">
        <div className="row icon-row justify-content-center">
          <div className="col-sm-12 col-md-2 text-center">
            ...
            <span className="logo-text ms-1">Twitter</span>
          </div>
          <div className="col-sm-12 col-md-2 text-center">
            <i className="fa-brands fa-facebook-f"></i>{" "}
            <span className="logo-text ms-1">Facebook</span>
          </div>
          <div className="col-sm-12 col-md-2 text-center">
            <i className="fa-solid fa-envelope"></i>{" "}
            <span className="logo-text ms-1">Gmail</span>
          </div>
          <div className="col-sm-12 col-md-2 text-center">
            <i className="fa-brands fa-slack"></i>{" "}
            <span className="logo-text ms-1">Slack</span>
          </div>
          <div className="col-sm-12 col-md-2 text-center">
            <i className="fa-brands fa-reddit-alien"></i>{" "}
            <span className="logo-text ms-1">Reddit</span>
          </div>
          <div className="col-sm-12 col-md-2 text-center">
            <i className="fa-brands fa-youtube"></i>{" "}
            <span className="logo-text ms-1">Youtube</span>
          </div>
        </div>
        ...
        <div className="row my-5 justify-content-center">
          ...
          <div className="col-md-5 mt-3 pe-0">
            ...
            <div className="row g-3 align-items-center justify-content-between">
              ...
              <div className="col-auto p-0">
                <button type="button" className="btn btn-primary waitlist-btn">
                  Sign Up
                </button>
              </div>
            </div>
