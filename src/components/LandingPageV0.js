          ...
          <div className="row justify-content-center">
            <div className="col-11 py-5">
              <p className="tools-heading text-center py-5">
                Tools designed for the growing wave of forward-thinking
                      ...
                      <div className="col-md-6 col-sm-12 p-0">
                        <div className="feature1">
                          <div className="py-5">
                            <br />
                            <br />
                            <h2 className="badge rounded-pill funge-bgcolor px-3 py-2 fs-6 w-600">
                              COMING SOON
                            </h2>
                            ...
                            <p className="sub-heading pe-4">
                              We're launching a VoIP and instant messaging
                              social platform where you can find and share ideas
                              in private chats or on community channels using
                              voice, video calls, text messages and other media.
                            </p>
                          </div>
                        </div>
                      </div>
                  ...
                  <div className="container">
                    <div className="row">
                      <div className="col-sm-12 col-md-6 text-center">
                        <div className="p-5">
                          <img
                            src="./assets/images/talentGraph.png"
                        ...
                        <div className="feature1">
                          ...
                          <div className="p-4">
                            ...
                            <p className="sub-heading">
                              Funge talent marketplace is the fastest and most
                              efficient way to source top Web3 talent. Seek and
                              hire experts in smart contract development, web
                              design, tokenomics creation, discord management,
                              marketing, and more.
                            </p>
                          </div>
                        </div>
                      ...
                      <div className="col-sm-12 col-md-6 p-0">
                        <div className="feature1">
                          ...
                          <div className="py-4 pe-4">
                            ...
                            <p className="sub-heading pe-4">
                              No need to hold multiple wallets to store and
                              manage your tokens. Each user receives a built-in
                              Funge wallet that allows them easily monitor, send
                              and receive their crypto assets.
                            </p>
                          </div>
                        </div>
                      </div>
